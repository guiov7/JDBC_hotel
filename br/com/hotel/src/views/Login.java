...
import br.com.hotel.src.controller.AutenticadorController;
import br.com.hotel.src.modelo.Atendente;
...
public class Login extends JFrame {
	...
	private AutenticadorController usuarioController;
	...
	public Login() {
		...
		logo.setIcon(new ImageIcon(Login.class.getResource("./images/aH-40px.png")));
	...
	private void autenticar() {
		this.usuarioController = new AutenticadorController( new Atendente(txtUsuario.getText(), txtSenha.getText()) );
