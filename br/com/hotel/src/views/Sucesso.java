...
public class Sucesso extends JDialog {
	...
	public Sucesso() {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(Sucesso.class.getResource("./images/logo-hotel-40px.png")));
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(Sucesso.class.getResource("./images/logo-hotel-100px.png")));
