...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		imagenFundo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("./images/menu-img.png")));
		panel.add(imagenFundo);

		JLabel logo = new JLabel("");
		logo.setBounds(722, 80, 150, 156);
		logo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("./images/aH-150.png")));
		panel.add(logo);
		...
		JLabel lblCopyR = new JLabel("Desenvolvido por Guiov7© 2023");
