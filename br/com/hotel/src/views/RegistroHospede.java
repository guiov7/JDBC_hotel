...
public class RegistroHospede extends JFrame {
	...
	public RegistroHospede(Reserva reserva) {
		...
		txtDataNasc.getCalendarButton()
				.setIcon(new ImageIcon(RegistroHospede.class.getResource("./images/icon-reservas.png")));
		...
		JLabel lblTitulo = new JLabel("REGISTRO HOSPEDE");
		lblTitulo.setBounds(606, 55, 234, 42);
		lblTitulo.setForeground(new Color(12, 138, 199));
		lblTitulo.setFont(new Font("Roboto Black", Font.PLAIN, 23));
		contentPane.add(lblTitulo);

		JLabel lblNumeroReserva = new JLabel("N° DE RESERVA");
		...
		btnSalvar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
                try {
					...
					JOptionPane.showMessageDialog(null, "A data de nascimento precisa ser preenchida");
				}
			}
		});
		...
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHospede.class.getResource("./images/logo-hotel-100px.png")));
	}
	...
	private void salvar() {
		...
		JOptionPane.showMessageDialog(null,
				"Cadastro CONCLUÍDO!\n O número da sua reserva é: " + txtNomeReserva.getText());
	}
