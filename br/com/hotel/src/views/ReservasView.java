...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource("./images/logo-hotel-40px.png")));
		...
		txtDataE.getCalendarButton()
				.setIcon(new ImageIcon(ReservasView.class.getResource("./images/icon-reservas.png")));
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView.class.getResource("./images/logo-hotel-100px.png")));
		...
		imagenFundo.setIcon(new ImageIcon(ReservasView.class.getResource("./images/reservas-img-3.png")));
